...
<head>
	...
	<title>Online Auction - Administrator</title>
					...
					<h1>Welcome Administrator</h1>
						...
						<div class="two_third column">
                          ...
                          <form method="post" name="prodform" id="prodform" action="" enctype='multipart/form-data'>
                                ...
                                <div id="inputcon">
                                <ul><input type="text" name="prodname" class="namewidth"  onkeyup="isalphanum(this)"  /></ul>
                                <p><input type="text" name="startingbid" class="namewidth" onkeyup="isnum(this)"/></p>
                                <p><input type="text" name="regularprice" class="namewidth" onkeyup="isnum(this)"/></p>
                                <p><?php cats(); ?></p>
