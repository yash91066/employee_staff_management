...
<body>
	<div id="container">
			<center><h5>Unapproved Product List</h5></center>
            <div id="bodycon">
            <table id="demoTable" style="border: 1px solid #ccc;" cellspacing="0" width="90%">
        <thead>
                <?php echo '<tr>';
                        echo '<th>Pid</th>';
						 echo '<th>Name</th>';
        ...
        <tbody>
        	<?php 
			$appproduct = mysql_query("SELECT * from productsforapproval where status = 0") or die(mysql_error());
			WHILE($row = mysql_fetch_array($appproduct)){
				...
				echo 
					"<tr>
						...
						<td>".$row['sellerpayaccount']."</td>
                        <td align='center'><a href='approve.php?pid=$prodid'><img src='./icons/5.png' alt = '0' width='35' height='25'/></a></td>
						<td align='center'><a href='disapprove.php?pid=$prodid'><img src='./icons/116.png' alt = '0' width='35' height='25'/></a></td>
					</tr>";
			}
			?>
