...
<script type='text/javascript'>
    ...
    <div class="left_content">
      <div class="title_box">Online Auction</div>
      <ul class="left_menu">
		<div class="mandm">
	...
	<!-- Mission and Vission -->
		...
		<div class="prod_box_big">
			...
			<div class="center_prod_box_big">
							<div class="welc"><center>Welcome to Online Auctiion</center></div>
		  ...
		  <div class="prod_box_big">
			...
			<div class="center_prod_box_big">
							...
							<div class="welcsub"><center><p>Welcome to Bidding Zone User Agreement. This agreement describes the terms and conditions
									applicable to your use of our services. By clicking the "I Accept" button, you accept their terms and 
			 ...
			 <div class='companyfeedback'>
				 ...
				 <span class="blue"><li>Joining Online Auction is free. You are responsible for paying
		 ...
		 <div class="developer">
		  ...
		  <div class="prod_box_big">
			...
			<div class="center_prod_box_big">
							...
							<div class="welcsub"><center><p>the following students have developed the website<p></center></div>
				<div class='logreg'>
					<div class="loginb">
						<div class="top_prod_box"></div>
						<div class="center_prod_box">
				...
				<div class='developer'>
					<div class="loginc">
					<br><br>					
					<span class="blue">Margi</span>   
					<br><br><br>					
					<span class="blue">Margi1</span> 
					<br><br><br>					
					<span class="blue">Margi2</span> 					
				</div>
			  </div>
			   </div>
			<div class="bottom_prod_box_big"></div>
