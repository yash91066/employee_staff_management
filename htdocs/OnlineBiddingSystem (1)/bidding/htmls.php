<?php
	function headhtml(){
	  ...
	  <script type="text/javascript">
			...
			<div id="main_container">
			  ...
			  <div id="header">
			  <div id="logo"> <img src="images/logo.png" alt=""  width="250" height="120" /></div>
	...
	function foothtml(){
		echo ' <div class="footer">
				<div class="left_footer"> <img src="images/footer_logo.png" alt="" width="200" height="50"/> </div>
				<div class="center_footer"> Online Auction. All Rights Reserved 2016<br />
				</div>
