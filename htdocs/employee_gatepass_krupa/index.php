    ...
    <div class="row justify-content-center">
        ...
        <div class="card card-primary card-tabs">
            ...
            <ul class="nav nav-tabs" id="panel-tab" role="tablist">
                ...
                <li class="nav-item">
                <a class="nav-link" id="custom-tabs-one-visitors-tab" data-toggle="pill" href="#custom-tabs-one-visitors" role="tab" aria-controls="custom-tabs-one-visitors" aria-selected="false">Visitors Clock In</a>
                </li>
                 <li class="nav-item">
                <a class="nav-link" id="custom-tabs-one-visitors-clockout-tab" data-toggle="pill" href="#custom-tabs-one-visitors-clockout" role="tab" aria-controls="custom-tabs-one-visitors-clockout" aria-selected="false">Visitors Clock Out</a>
                </li>
            ...
            <div class="tab-content" id="panel-tab-Content">
                           ...
                           <div class="col-12">
                               <div class="row justify-content-center">
                                   <div class="col-md-8">
                                       ...
                                       <div class="form-group text-center">
                                           <button class="btn btn-lg btn-custom rounded-pill btn-primary elog px-4 col-4" type="button" data-type='1'>Clock In</button>
                                           <button class="btn btn-lg btn-custom rounded-pill btn-danger elog px-4 col-4" type="button" data-type='2' >Clock Out</button>
                                       </div>
                                   </div>
                               </div>
                           </div>
                ...
                <div class="tab-pane fade" id="custom-tabs-one-visitors-clockout" role="tabpanel" aria-labelledby="custom-tabs-one-visitors-clockout-tab">
                <div class="container-fluid py-5">
                       <form action="" id="visitor-log-form">
                           <input type="hidden" name="type">
                           <div class="col-12">
